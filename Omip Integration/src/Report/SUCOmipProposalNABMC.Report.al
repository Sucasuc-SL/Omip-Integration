...
/// <summary>
/// Report SUC Omip Proposal Comercial v2 (ID 50158).
/// </summary>
report 50158 "SUC Omip Proposal NAB MC"
{
    Caption = 'Omip Proposal Comercial';
    WordLayout = './src/Report/Layouts/Proposals/Nabalia/SUCOmipProposalNABMC.docx';
    DefaultLayout = Word;
        ...
        case LineNoPowerEntry of
            1:
                case SUCOmipProposel.Times.AsInteger() of
                    1:
                        DummyEnergyEntry := LineBreak(12);
                    2:
                        DummyEnergyEntry := LineBreak(10);
                    3:
                        DummyEnergyEntry := LineBreak(8);
                    4:
                        DummyEnergyEntry := LineBreak(4);
                    5:
