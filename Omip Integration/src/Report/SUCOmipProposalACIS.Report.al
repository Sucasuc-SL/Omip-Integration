...
/// <summary>
/// Report SUC Omip Proposal Comercial v3 (ID 50156).
/// </summary>
report 50156 "SUC Omip Proposal ACIS"
{
    Caption = 'Omip Proposal Comercial';
    WordLayout = './src/Report/Layouts/Proposals/Acis/SUCOmipProposalACIS.docx';
    DefaultLayout = Word;
