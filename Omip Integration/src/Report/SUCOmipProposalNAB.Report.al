...
/// <summary>
/// Report SUC Omip Proposal Comercial v2 (ID 50155).
/// </summary>
report 50155 "SUC Omip Proposal NAB"
{
    Caption = 'Omip Proposal Comercial';
    WordLayout = './src/Report/Layouts/Proposals/Nabalia/SUCOmipProposalNAB.docx';
    DefaultLayout = Word;
