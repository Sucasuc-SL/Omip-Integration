...
/// <summary>
/// Report SUC Omip Contract 12M (ID 50159).
/// </summary>
report 50159 "SUC Omip Contract 12M MC NAB"
{
    Caption = 'Omip Contract Comercial';
    WordLayout = './src/Report/Layouts/Contracts/Nabalia/SUCOmipContract12MMCNAB.docx';
    DefaultLayout = Word;
