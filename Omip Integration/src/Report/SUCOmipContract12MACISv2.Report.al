...
/// <summary>
/// Report SUC Omip Contract 12M v3 (ID 50161).
/// </summary>
report 50161 "SUC Omip Contract 12M ACIS v2"
{
    Caption = 'Omip Contract Comercial';
    WordLayout = './src/Report/Layouts/Contracts/Acis/SUCOmipContract12MACISv2.docx';
    DefaultLayout = Word;
